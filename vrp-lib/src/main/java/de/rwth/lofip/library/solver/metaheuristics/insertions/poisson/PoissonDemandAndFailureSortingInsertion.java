...
public class PoissonDemandAndFailureSortingInsertion extends
	...
	@Override
	protected CustomerWithCost calculateCostHook(Customer customer, Tour tour,
			double approximateEquality) {
	...
	@Override
	protected Comparator<Tour> setTourComparator() {
