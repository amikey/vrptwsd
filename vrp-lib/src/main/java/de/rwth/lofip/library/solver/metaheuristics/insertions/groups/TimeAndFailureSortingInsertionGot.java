...
import de.rwth.lofip.library.solver.metaheuristics.insertions.AbstractTimeAndFailureSortingInsertionGot;
import de.rwth.lofip.library.solver.metaheuristics.insertions.util.DeterministicTourComparatorWrtDemand;
 ...
 * 
 */
public class TimeAndFailureSortingInsertionGot extends
        AbstractTimeAndFailureSortingInsertionGot {
    ...
    {
    	throw new RuntimeException("Create Tour Hook in TFSI sollte nicht verwendet werden");
    }
