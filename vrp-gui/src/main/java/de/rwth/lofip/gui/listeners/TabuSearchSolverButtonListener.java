...
public class TabuSearchSolverButtonListener implements ActionListener {
    ...
    public TabuSearchSolverButtonListener(SolutionPanel solutionPanel,
            LogPanel logPanel) {
        ...
        if (workerIsWorking) {
            ...
            worker = new SwingWorker<Solution, IntermediateSolution>() {
                ...
                protected Solution doInBackground() throws Exception {
                    MetaSolverInterface solver = new TabuSearchHeuristic() {
                        @Override
